...
<footer class="site-footer">
  <!--  <div class="site-footer-legal">© 2019 <a href="http://themeforest.net/item/remark-responsive-bootstrap-admin-template/11989202">Universitas Riau</a></div> -->
  <div class="site-footer-right">
    <!-- Crafted with <i class="red-600 wb wb-heart"></i> by <a href="https://themeforest.net/user/creation-studio">Creation Studio</a> -->
    © 2021 <a href="https://umri.ac.id/home/lang/id">Universitas Muhammadiyah Riau</a>
  </div>
</footer>
<!-- Core  -->
...
<script src="<?= base_url('assets/center/assets/examples/js/dashboard/v1.js') ?>"></script>
