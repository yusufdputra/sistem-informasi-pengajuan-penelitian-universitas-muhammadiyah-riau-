...
<head>
  ...
  <title>Sistem Informasi Pengajuan Penelitian Universitas Lancang Kuning</title>
...
<body class="animsition dashboard">
    <!--[if lt IE 8]>
      ...
      role="navigation" style="background-color: #f6ee53">
...
<ul class="nav navbar-toolbar navbar-right navbar-toolbar-right">
  <li class="nav-item dropdown">
    <a class="nav-link" href="<?=base_url('login/logout')?>" tittle="Login">
    <i class="icon fa fa-user" aria-hidden="true"> Logout </i>
...
<!-- End Site Navbar Seach -->
  ...
  <div class="site-menubar-header">
    ...
    <div class="cover overlay">
      <img class="cover-image" src="<?=base_url('assets/center/assets//examples/images/dashboard-header.jpg')?>"
      alt="...">
      <div class="overlay-panel vertical-align overlay-background">
        <div class="vertical-align-middle">
          ...
          <div class="site-menubar-info">
            <h5 class="site-menubar-user" style="text-align: center;"></h5><br>
            <p class="site-menubar-email" style="text-align: center;"></p>
          </div>
        </div>
      </div>
    </div>
