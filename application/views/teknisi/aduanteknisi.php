              ...
              <table class="table table-hover dataTable table-striped w-full" id="exampleTableTools">
                ...
                <tbody>
                 ...
                 <tr>
                  ...
                  <td style="text-align: center;">
                    <!-- <a class="btn btn-success btn-xs" data-toggle="modal" data-target="#modal_edit<?php echo $id_aduan;?>" style="color: white">Ubah Status </a> -->
                    <a class="btn btn-success btn-xs" href="<?= base_url()?>teknisi/edit_status_aduan/<?=$id_aduan?>" style="color: white">Ubah Status</a>
                  </td>
                </tr>
              <?php endforeach ?>
            </tbody>
    ...
    <div class="modal-dialog modal-simple modal-center">
      <div class="modal-content">
        ...
        <div class="modal-body">
         ...
         <form class="form-horizontal" method="post" action="<?php echo base_url().'teknisi/edit_status'?>">
        ...
        <div class="form-group form-material" data-plugin="formMaterial">
          <label class="" for="textarea">Balasan</label>
          <textarea class="form-control" id="textarea" name="balasan" rows="3"></textarea>
        </div>
      </div>
