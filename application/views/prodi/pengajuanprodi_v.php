 ...
 <?php foreach ($data as $row) : ?>
   ...
   <div class="modal fade" id="modal_edit<?= $row->id_pengajuan ?>" aria-hidden="true" aria-labelledby="modal_edit" role="dialog" tabindex="-1">
         ...
         <div class="modal-body">
           ...
           <form class="form-horizontal" method="post" action="<?php echo base_url() . 'prodi/edit_status' ?>">
             ...
             <div class="row">
               ...
               <div class="col-md-6">
                 <div class="form-group form-material" data-plugin="formMaterial">
                   ...
                   <select class="form-control" id="selectMulti" multiple="" required name="status1">
             ...
             <div class="form-group form-material" data-plugin="formMaterial">
               ...
               <select id="level" class="form-control" id="qwqw" name="pembimbing1" required>
                 <option value=""> -- Pilih Dosen -- </option>
                 <?php foreach ($dosen as $key => $value) {
                  ?>
                   <option value="<?= $value->nama ?>" <?= set_value('pembimbing1') == '$value->id' ? 'selected' : '' ?>><?= $value->nama ?></option>
                 <?php
                  } ?>
             ...
             <div class="form-group form-material" data-plugin="formMaterial">
               ...
               <select id="level" class="form-control" id="qwe" name="pembimbing2">
                 <option value=""> -- Pilih Dosen -- </option>
                 <?php foreach ($dosen as $key => $value) {
                  ?>
                   <option value="<?= $value->nama ?>" <?= set_value('pembimbing2') == '$value->id' ? 'selected' : '' ?>><?= $value->nama ?></option>
                 <?php
                  } ?>
